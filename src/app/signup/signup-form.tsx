...
export function SignupForm() {
  ...
  return (
    <div style={pageStyle}>
      ...
      {/* Content */}
      <div className="relative z-10 w-full px-4" style={{ maxWidth: 400 }}>
        {/* Wordmark */}
        ...
        <div className="relative">
          ...
          <div style={cardStyle}>
            ...
            <p style={{ fontSize: 12.5, color: "rgba(255,255,255,0.3)", lineHeight: 1.5, marginBottom: "1.75rem" }}>
              Analyse your first contract in under 30 seconds.
            </p>
            ...
            <p className="text-center" style={{ marginTop: "1.25rem", fontSize: 12 }}>
              <span style={{ color: "rgba(255,255,255,0.2)" }}>Already have an account? </span>
